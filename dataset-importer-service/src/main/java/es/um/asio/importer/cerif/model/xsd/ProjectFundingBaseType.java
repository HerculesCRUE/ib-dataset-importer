...
/**
 * A common supertype for projects and funding
 * 			
 * 
 * <p>Clase Java para ProjectFunding__BaseType complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="ProjectFunding__BaseType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "ProjectFunding__BaseType")
@XmlSeeAlso({
    Project.class,
    Funding.class
})
public class ProjectFundingBaseType
