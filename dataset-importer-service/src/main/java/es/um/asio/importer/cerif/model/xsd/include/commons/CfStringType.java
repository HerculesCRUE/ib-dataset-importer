...
/**
 * <p>Clase Java para cfString__Type complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="cfString__Type"&gt;
 *   &lt;simpleContent&gt;
...
@XmlType(name = "cfString__Type", propOrder = {
    "value"
})
@XmlSeeAlso({
    CfSimpleStringLinkType.class,
    CfIdentifierType.class,
    ORCIDType.class,
    ResearcherIDType.class,
    ScopusAuthorIDType.class,
    ISNIType.class,
    DAIType.class
})
public class CfStringType {
