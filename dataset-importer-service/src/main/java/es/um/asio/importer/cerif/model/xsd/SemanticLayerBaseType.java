...
/**
 * A common supertype for semantic layer objects:
 * 				classification schemes and classifications
 * 
 * <p>Clase Java para SemanticLayer__BaseType complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="SemanticLayer__BaseType"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "SemanticLayer__BaseType")
@XmlSeeAlso({
    ClassScheme.class,
    CfClassBaseType.class
})
public class SemanticLayerBaseType
