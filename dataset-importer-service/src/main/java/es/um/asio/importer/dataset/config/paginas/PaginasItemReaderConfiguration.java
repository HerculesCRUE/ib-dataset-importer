...
public class PaginasItemReaderConfiguration {
    ...
    protected  ItemReader<Alegacion> alegacionesReader() {
		return DataSetItemReader.baseReader(Alegacion.class, "Paginas/Alegaciones.xml", importDataSetProperties.getDataSetPath());
	}
    
    @Bean
    @StepScope
    protected  ItemReader<Articulo> articuloReader() {
		return DataSetItemReader.baseReader(Articulo.class, "Paginas/Articulos.xml", importDataSetProperties.getDataSetPath());
	}
    
    @Bean
    @StepScope
    protected  ItemReader<AutorArticulo> autorArticuloReader() {
		return DataSetItemReader.baseReader(AutorArticulo.class, "Paginas/Autores articulos.xml", importDataSetProperties.getDataSetPath());
	}
    
    @Bean
    @StepScope
    protected  ItemReader<AutorCapituloLibro> autorCapituloLibroReader() {
		return DataSetItemReader.baseReader(AutorCapituloLibro.class, "Paginas/Autores captitulos libros.xml", importDataSetProperties.getDataSetPath());
	}
    
    @Bean
    @StepScope
    protected  ItemReader<AutorCongreso> autorCongresoReader() {
		return DataSetItemReader.baseReader(AutorCongreso.class, "Paginas/Autores congresos.xml", importDataSetProperties.getDataSetPath());
	}
    
    @Bean
    @StepScope
    protected  ItemReader<AutorDiseno> autorDisenoReader() {
		return DataSetItemReader.baseReader(AutorDiseno.class, "Paginas/Autores diseños.xml", importDataSetProperties.getDataSetPath());
	}
    
    @Bean
    @StepScope
    protected  ItemReader<AutorExposicion> autorExposicionReader() {
		return DataSetItemReader.baseReader(AutorExposicion.class, "Paginas/Autores exposiciones.xml", importDataSetProperties.getDataSetPath());
	}
    
    @Bean
    @StepScope
    protected  ItemReader<AutorLibro> autorLibroReader() {
		return DataSetItemReader.baseReader(AutorLibro.class, "Paginas/Autores libros.xml", importDataSetProperties.getDataSetPath());
	}
    
    @Bean
    @StepScope
    protected  ItemReader<AutorPrologoLibro> autorPrologoLibroReader() {
		return DataSetItemReader.baseReader(AutorPrologoLibro.class, "Paginas/Autores prologo libros.xml", importDataSetProperties.getDataSetPath());
	}
    
    @Bean
    @StepScope
    protected  ItemReader<AyudaIniciacion> ayudaIniciacionReader() {
		return DataSetItemReader.baseReader(AyudaIniciacion.class, "Paginas/Ayudas iniciacion.xml", importDataSetProperties.getDataSetPath());
	}
    
    @Bean
    @StepScope
    protected  ItemReader<AyudaPostdoctoral> ayudaPostdoctoralReader() {
		return DataSetItemReader.baseReader(AyudaPostdoctoral.class, "Paginas/Ayudas postdoctorales.xml", importDataSetProperties.getDataSetPath());
	}
    
    @Bean
    @StepScope
    protected  ItemReader<CapituloLibro> capituloLibroReader() {
		return DataSetItemReader.baseReader(CapituloLibro.class, "Paginas/Capitulos libros.xml", importDataSetProperties.getDataSetPath());
	}
    
    @Bean
    @StepScope
    protected  ItemReader<ComiteCongreso> comiteCongresoReader() {
		return DataSetItemReader.baseReader(ComiteCongreso.class, "Paginas/Comite congresos.xml", importDataSetProperties.getDataSetPath());
	}
    
    @Bean
    @StepScope
    protected  ItemReader<ComiteEditorial> comiteEditorialReader() {
		return DataSetItemReader.baseReader(ComiteEditorial.class, "Paginas/Comite editorial.xml", importDataSetProperties.getDataSetPath());
	}
    
    @Bean
    @StepScope
    protected  ItemReader<Congreso> congresoReader() {
		return DataSetItemReader.baseReader(Congreso.class, "Paginas/Congresos.xml", importDataSetProperties.getDataSetPath());
	}
    
    @Bean
    @StepScope
    protected  ItemReader<ContratoPostdoctoral> contratoPostdoctoralReader() {
		return DataSetItemReader.baseReader(ContratoPostdoctoral.class, "Paginas/Contratos postdoctorales.xml", importDataSetProperties.getDataSetPath());
	}
    
    @Bean
    @StepScope
    protected  ItemReader<Convocatoria> convocatoriaReader() {
		return DataSetItemReader.baseReader(Convocatoria.class, "Paginas/Convocatorias.xml", importDataSetProperties.getDataSetPath());
	}
    
    @Bean
    @StepScope
    protected  ItemReader<DiplomaEstudiosAvanzados> diplomaEstudiosAvanzadosReader() {
		return DataSetItemReader.baseReader(DiplomaEstudiosAvanzados.class, "Paginas/Diploma estudios avanzados.xml", importDataSetProperties.getDataSetPath());
	}
    
    @Bean
    @StepScope
    protected  ItemReader<DiplomaEstudiosAvanzadosExterno> diplomaEstudiosAvanzadosExternoReader() {
		return DataSetItemReader.baseReader(DiplomaEstudiosAvanzadosExterno.class, "Paginas/Diploma estudios avanzados externo.xml", importDataSetProperties.getDataSetPath());
	}
    
    @Bean
    @StepScope
    protected  ItemReader<DirectorContratoPostdoctoral> directorContratoPostdoctoralReader() {
		return DataSetItemReader.baseReader(DirectorContratoPostdoctoral.class, "Paginas/Directores contratos postdoctorales.xml", importDataSetProperties.getDataSetPath());
	}
    
    @Bean
    @StepScope
    protected  ItemReader<DirectorDiplomaEstudiosAvanzados> directorDiplomaEstudiosAvanzadosReader() {
		return DataSetItemReader.baseReader(DirectorDiplomaEstudiosAvanzados.class, "Paginas/Directores diploma estudios avanzados.xml", importDataSetProperties.getDataSetPath());
	}
    
    @Bean
    @StepScope
    protected  ItemReader<DirectorDiplomaEstudiosAvanzadosExterno> directorDiplomaEstudiosAvanzadosExternoReader() {
		return DataSetItemReader.baseReader(DirectorDiplomaEstudiosAvanzadosExterno.class, "Paginas/Directores diploma estudios avanzados externo.xml", importDataSetProperties.getDataSetPath());
	}
    
    @Bean
    @StepScope
    protected  ItemReader<DirectorTesinaExterna> directorTesinaExternaReader() {
		return DataSetItemReader.baseReader(DirectorTesinaExterna.class, "Paginas/Directores tesinas externas.xml", importDataSetProperties.getDataSetPath());
	}
    
    @Bean
    @StepScope
    protected  ItemReader<DirectorTesisExterna> directorTesisExternaReader() {
		return DataSetItemReader.baseReader(DirectorTesisExterna.class, "Paginas/Directores tesis externas.xml", importDataSetProperties.getDataSetPath());
	}
    
    @Bean
    @StepScope
    protected  ItemReader<Diseno> disenoReader() {
		return DataSetItemReader.baseReader(Diseno.class, "Paginas/Diseños.xml", importDataSetProperties.getDataSetPath());
	}
    ...
    protected  ItemReader<Estancia> estanciaReader() {
		return DataSetItemReader.baseReader(Estancia.class, "Paginas/Estancias.xml", importDataSetProperties.getDataSetPath());
	}
    
    @Bean
    @StepScope
    protected  ItemReader<EstanciaBreve> estanciaBreveReader() {
		return DataSetItemReader.baseReader(EstanciaBreve.class, "Paginas/Estancias breves.xml", importDataSetProperties.getDataSetPath());
	}
    ...
    protected  ItemReader<InvestigadorProyectoCooperacionInternacional> investigadorProyectoCooperacionInternacionalReader() {
		return DataSetItemReader.baseReader(InvestigadorProyectoCooperacionInternacional.class, "Paginas/Investigadores proyectos cooperacion internacional.xml", importDataSetProperties.getDataSetPath());
	}
    
    @Bean
    @StepScope
    protected  ItemReader<Libro> libroReader() {
		return DataSetItemReader.baseReader(Libro.class, "Paginas/Libros.xml", importDataSetProperties.getDataSetPath());
	}
    
    @Bean
    @StepScope
    protected  ItemReader<MiembroComiteCongreso> miembroComiteCongresoReader() {
		return DataSetItemReader.baseReader(MiembroComiteCongreso.class, "Paginas/Miembros comite congresos.xml", importDataSetProperties.getDataSetPath());
	}
    
    @Bean
    @StepScope
    protected  ItemReader<PaisPatente> paisPatenteReader() {
		return DataSetItemReader.baseReader(PaisPatente.class, "Paginas/Paises patentes.xml", importDataSetProperties.getDataSetPath());
	}
    
    @Bean
    @StepScope
    protected  ItemReader<PalabraClaveArticulo> palabraClaveArticuloReader() {
		return DataSetItemReader.baseReader(PalabraClaveArticulo.class, "Paginas/Palabras clave articulos.xml", importDataSetProperties.getDataSetPath());
	}
    
    @Bean
    @StepScope
    protected  ItemReader<PalabraClaveComiteCongreso> palabraClaveComiteCongresoReader() {
		return DataSetItemReader.baseReader(PalabraClaveComiteCongreso.class, "Paginas/Palabras clave comite congresos.xml", importDataSetProperties.getDataSetPath());
	}
    
    @Bean
    @StepScope
    protected  ItemReader<PalabraClaveCongreso> palabraClaveCongresoReader() {
		return DataSetItemReader.baseReader(PalabraClaveCongreso.class, "Paginas/Palabras clave congresos.xml", importDataSetProperties.getDataSetPath());
	}
    ...
    protected  ItemReader<PalabraClavePrologoLibro> palabraClavePrologoLibroReader() {
		return DataSetItemReader.baseReader(PalabraClavePrologoLibro.class, "Paginas/Palabras clave prologo libros.xml", importDataSetProperties.getDataSetPath());
	}
    
    @Bean
    @StepScope
    protected  ItemReader<PrologoLibro> prologoLibroReader() {
		return DataSetItemReader.baseReader(PrologoLibro.class, "Paginas/Prologo libros.xml", importDataSetProperties.getDataSetPath());
	}
    
    @Bean
    @StepScope
    protected  ItemReader<ProyectoCooperacionInternacional> proyectoCooperacionInternacionalReader() {
		return DataSetItemReader.baseReader(ProyectoCooperacionInternacional.class, "Paginas/Proyectos cooperacion internacional.xml", importDataSetProperties.getDataSetPath());
	}
    
    @Bean
    @StepScope
    protected  ItemReader<RequisitoContratoPostdoctoral> requisitoContratoPostdoctoralReader() {
		return DataSetItemReader.baseReader(RequisitoContratoPostdoctoral.class, "Paginas/Requisitos contratos postdoctorales.xml", importDataSetProperties.getDataSetPath());
	}
    
    @Bean
    @StepScope
    protected  ItemReader<SolicitudCambioGrupoInvestigacion> solicitudCambioGrupoInvestigacionReader() {
		return DataSetItemReader.baseReader(SolicitudCambioGrupoInvestigacion.class, "Paginas/Solicitudes cambios grupos investigacion.xml", importDataSetProperties.getDataSetPath());
	}
    
    @Bean
    @StepScope
    protected  ItemReader<TesisDirigidaUMUNoRegistrada> tesisDirigidaUMUNoRegistradaReader() {
		return DataSetItemReader.baseReader(TesisDirigidaUMUNoRegistrada.class, "Paginas/Tesis dirigidas UMU no registradas.xml", importDataSetProperties.getDataSetPath());
	}
    
    @Bean
    @StepScope
    protected  ItemReader<TesinaExterna> tesinaExternaReader() {
		return DataSetItemReader.baseReader(TesinaExterna.class, "Paginas/Tesinas externas.xml", importDataSetProperties.getDataSetPath());
	}
    
    @Bean
    @StepScope
    protected  ItemReader<TesisExterna> tesisExternaReader() {
		return DataSetItemReader.baseReader(TesisExterna.class, "Paginas/Tesis externas.xml", importDataSetProperties.getDataSetPath());
	}
