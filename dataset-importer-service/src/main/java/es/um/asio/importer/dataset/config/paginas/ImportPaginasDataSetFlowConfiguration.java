...
public class ImportPaginasDataSetFlowConfiguration extends ImportDataSetFlowConfigurationBase {
    ...
    public Flow getFlow() {        
        return new FlowBuilder<SimpleFlow>(getFlowName())
                ...
                .next(createStep(DiplomaEstudiosAvanzadosExterno.class, configuration.diplomaEstudiosAvanzadosExternoReader()))
                .next(createStep(DirectorContratoPostdoctoral.class, configuration.directorContratoPostdoctoralReader()))
                .next(createStep(DirectorDiplomaEstudiosAvanzados.class, configuration.directorDiplomaEstudiosAvanzadosReader()))
                .next(createStep(DirectorDiplomaEstudiosAvanzadosExterno.class, configuration.directorDiplomaEstudiosAvanzadosExternoReader()))
                ...
                .next(createStep(InvestigadorProyectoCooperacionInternacional.class, configuration.investigadorProyectoCooperacionInternacionalReader()))
                ...
                .next(createStep(ProyectoCooperacionInternacional.class, configuration.proyectoCooperacionInternacionalReader()))
                .next(createStep(RequisitoContratoPostdoctoral.class, configuration.requisitoContratoPostdoctoralReader()))
                .next(createStep(SolicitudCambioGrupoInvestigacion.class, configuration.solicitudCambioGrupoInvestigacionReader()))
                .next(createStep(TesisDirigidaUMUNoRegistrada.class, configuration.tesisDirigidaUMUNoRegistradaReader()))
